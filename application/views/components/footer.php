        ...
        <div class="xl:container px-4 sm:px-8">
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 py-8 sm:py-16">
                ...
                <div>
                    ...
                    <table class="mt-3">
                        <tr>
                            <td class="pr-4"><i class=" text-lg fa-solid fa-location-dot" class="font-bold"></i></td>
                            <td class="py-2"><a href="#" class="block text-sm text-gray-500">Jl. Melati, Khusus Kota Selong, Kec. Selong, Kabupaten Lombok Timur, Nusa Tenggara Bar. 83618</a></td>
                        </tr>
                        <tr>
