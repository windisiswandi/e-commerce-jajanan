            ...
            <div class="col-sm-6 col-md-3">
                <div class="card card-stats card-round">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col col-stats ms-3 ms-sm-0">
                        <div class="numbers">
                            <p class="card-category">Penjualan bulan ini</p>
                            <h4 class="card-title"><?= "Rp ". number_format($sales_montly, 0, ".", "."); ?></h4>
                        </div>
                        </div>
                    </div>
                    </div>
            ...
            <div class="col-md-4">
                <div class="card card-primary card-round">
                    ...
                    <div class="card-head-row">
                        <div class="card-title">Laba Bulanan</div>
                        <div class="card-tools">
                        <!-- <div class="dropdown">
                            <button
                    ...
                    <div class="mb-4 mt-2">
                        <h1><?= "Rp ". number_format($sales_montly-$modal_montly, 0, ".", "."); ?></h1>
                    </div>
                    <div class="pull-in">
