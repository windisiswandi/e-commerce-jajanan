                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="exampleInputEmail1" value="<?= $pct->product_name ?>" name="product_name" placeholder="Masukan nama produk" required>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" aria-label="Default select example" name="category_id">
                                            <?php foreach($categories as $key => $category): ?>
                                                <option <?= $pct->category_id == $category->id ? 'selected' : '' ?> value="<?= $category->id; ?>"><?= $category->category_name; ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                    </div>
                                    <div class="mb-3">
                                        <label for="stock" class="form-label">stock</label>
                                        <input type="number" class="form-control" value="<?= $pct->stock ?>" id="stock" name="stock" placeholder="Masukan stock produk" required>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" onkeyup="changeToIDR(this)" value="<?= "Rp ".number_format($pct->product_modal, 0, ',', '.') ?>" id="product_modal" placeholder="Masukan harga modal" required>
                                        <input type="hidden" name="product_modal" value="<?= $pct->product_modal ?>" >
                                        <?= form_error("product_modal", '<small class="text-danger ml-3">', '</small>'); ?>
                                    </div>
                                    <div class="mb-3">
                                        <label for="harga_jual" class="form-label">Harga Jual</label>
                                        <input type="text" class="form-control" onkeyup="changeToIDR(this)" value="<?= "Rp ".number_format($pct->product_price, 0, ',', '.') ?>" id="product_price" placeholder="Masukan harga jual" required>
                                        <input type="hidden" name="product_price" value="<?= $pct->product_price ?>">
                                        <?= form_error("product_price", '<small class="text-danger ml-3">', '</small>'); ?>
                                    </div>
                                    <div class="mb-3">
                                        <label for="berat" class="form-label">Berat (g)</label>
                                        <input class="form-control" type="number" id="berat" name="weight" placeholder="Berat produk (gram)" value="<?= $pct->weight; ?>" required>
                                    </div>
