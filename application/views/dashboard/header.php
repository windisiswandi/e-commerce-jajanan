...
<html lang="en">
  <head>
    ...
    <link
      rel="icon"
      href="<?=base_url('assets/dashboard/img/kaiadmin/favicon.ico');?>"
      type="image/x-icon"
    />
    ...
    <script>
      WebFont.load({
        ...
        custom: {
          ...
          urls: ["<?=base_url('assets/dashboard/css/fonts.min.css')?>"],
        },
        active: function () {
    ...
    <link rel="stylesheet" href="<?=base_url('assets/dashboard/css/plugins.min.css');?>" />
    <link rel="stylesheet" href="<?=base_url('assets/dashboard/css/kaiadmin.min.css');?>" />
        ...
        <div class="sidebar-wrapper scrollbar scrollbar-inner">
          <div class="sidebar-content">
            <ul class="nav nav-secondary">
              ...
              <li class="nav-item <?= @$kategori ? 'active' : '' ?>">
              ...
              <ul class="navbar-nav topbar-nav ms-md-auto align-items-center">
                      ...
                      <div class="message-notif-scroll scrollbar-outer">
                        <div class="notif-center">
                          ...
                          <a href="#">
                            <div class="notif-img">
                              <img
                                src="<?=base_url('assets/dashboard/img/mlane.jpg')?>"
                                alt="Img Profile"
                              />
                            </div>
                            <div class="notif-content">
                      ...
                      <div class="notif-scroll scrollbar-outer">
                        <div class="notif-center">
                          ...
                          <a href="#">
                            <div class="notif-img">
                              <img
                                src="<?=base_url('assets/dashboard/img/profile2.jpg')?>"
                                alt="Img Profile"
                              />
                            </div>
                            <div class="notif-content">
                ...
                <li class="nav-item topbar-user dropdown hidden-caret">
                  ...
                  >
                    <div class="avatar-sm">
                      <img
                        src="<?=base_url('assets/dashboard/img/profile.jpg')?>"
                        alt="..."
